<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InterchangeEdit.aspx.cs" Inherits="SaleDelivery_InterchangeEdit" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="交接单资料" />
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
                <td class="label" style="width:30%;">交接单号码：</td>
                <td>
                    <asp:TextBox runat="server" ID="txtOrderNumber" Width="120px" CssClass="input readonly" ReadOnly="true" MaxLength="18"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="label">配送公司：</td>
                <td>
                    <asp:DropDownList ID="drpLogistic" runat="server" Width="120px" CssClass="select">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="label" style="width:30%;">配送公司收货人：</td>
                <td>
                    <asp:TextBox runat="server" ID="txtLogisticsUser" Width="120px" CssClass="input" MaxLength="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="label">
            ...
            <tr>
                ...
                <td>
                    <mwu:MagicToolBar CssClass="toolbar" OnItemCommand="MagicItemCommand" runat="server"
                        Layout="Div" ID="cmdScanLine">
                        <Items>
                            <mwu:MagicItem CommandName="ScanLine" ItemCssClass="toolbutton" ItemType="Navigate"
                                ImageUrl="../images/b_print.gif" OnlyClient="true"
                                Text="交接明细录入">
                            </mwu:MagicItem>
                        </Items>
                    </mwu:MagicToolBar>
