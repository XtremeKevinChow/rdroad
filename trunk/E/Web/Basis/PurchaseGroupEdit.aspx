<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseGroupEdit.aspx.cs"
    Inherits="system_PurchaseGroupEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            if($.trim($('#txtPurchGroupCode').val()).length == 0)
            {
                ShowMsg("采购组不能为空","警告");
                return false;
            }
...
<body>
    ...
    <div>
        <input type="hidden" id="txtCode" value="" runat="server" />
        <uc1:FunctionTitle ID="FunctionTitle1" runat="server" PageTitle="采购组编辑" />
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPurchGroupCode" runat="server" CssClass="input"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="label">
                ...
                <td>
                    <asp:TextBox ID="txtPurchGroupText" runat="server" Height="80px" TextMode="MultiLine"
