<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockSummaryQuery_ByItemCode.aspx.cs" Inherits="Inventory_StockSummaryQuery_ByItemCode" %>
...
<body>
    ...
    <input type="hidden" id="hidReturnUrl" runat="server" value="StockSummaryManage.aspx" />
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="库存查询" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="width:70px;" class="h">零售金额</td>
                ...
                <asp:Repeater ID="rptPO" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("itm_code")%></td>
                            <td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("sto_qty"), "#0.##")%></td>
                            <td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("cost_amt"), "#0.##")%></td>
                            <td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("retail_amt"), "#0.##")%></td>
                            <!--td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("sto_qty"), "#0.##")%></td>
                            <td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("sto_qty"), "#0.##")%></td>
                            <td  align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("sto_qty"), "#0.##")%></td-->
                            <td><%# Eval("itm_name")%></td>
