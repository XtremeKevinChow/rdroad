...
public partial class Inventory_AssistItemOutEdit : System.Web.UI.Page
{
        ...
        if (e.CommandName == "Save")
        {
            using (ISession session = new Session())
            {
                ...
                if (this.IsNew)
                {
                    ...
                    head.OrderTypeCode = StockInHead.ORD_TYPE_ASSIST_OUT;
                    ...
                    this.Response.Redirect("AssistItemOutNewLine.aspx?ordNum=" + head.OrderNumber + "&return=" + WebUtil.escape("AssistItemOutLine.aspx?ordNum=" + head.OrderNumber + "&return=" + WebUtil.escape(WebUtil.Param("return"))));
                    return;
                }
                ...
                this.Response.Redirect("AssistItemOutLine.aspx?ordNum=" + head.OrderNumber + "&return=" + WebUtil.escape(WebUtil.Param("return")));
            }
        }
    }
}