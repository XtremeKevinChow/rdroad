<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferNewLine.aspx.cs" Inherits="Inventory_TransferNewLine" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="添加移库明细" />
        ...
        <table class="datalist" id="data_list_table" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:55px;">可移库量</th>
                    <th style="width:55px;">移库量</th>
                    <th style="width:55px;">移入库位</th>
                    <th style="width:75px;">移入货架</th>
                </tr>
            </thead>
            <tbody>
                <asp:Repeater ID="repeatControl" runat="server" onitemdatabound="repeatControl_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            <td style="width:20px;">
                                <input id="checkbox" value='<%# Eval("StockDetailID") %>' type="checkbox" runat="server" />
                                <input id="hidTransferQty" value='<%# Eval("TransferQty") %>' type="text" runat="server" style="display:none;" />
                            </td>
                            ...
                            <td style="width:55px;">
                                <%# RenderUtil.FormatString(Eval("TransferQty"))%>
                            </td>
                            <td style="width:55px;">
                                <asp:TextBox ID="txtMoveQty" CssClass="input" Width="50px" runat="server"></asp:TextBox>
                            </td>
                            <td style="width:55px;">
                                <asp:DropDownList ID="drpToArea" runat="server" Width="50" CssClass="select"></asp:DropDownList>
                            </td>
                            <td style="width:75px;">
                                <asp:TextBox ID="txtToSection" CssClass="input" Width="70px" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
