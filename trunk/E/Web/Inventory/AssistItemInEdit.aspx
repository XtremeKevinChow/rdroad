<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssistItemInEdit.aspx.cs" Inherits="Inventory_AssistItemInEdit" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="修改辅料入库单" />
