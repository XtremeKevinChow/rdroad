<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleBySetCodeStat.aspx.cs" Inherits="Report_SaleBySetCodeStat" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="套装销售" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0">
                <tr>
                    <td  class="h nw" style="width:80px;">套装号</td>
                    <td  class="h nw">名称</td>
                    <td  class="h nw" style="width:75px;">销售量(套)</td>
                    <td  class="h nw" style="width:70px;">销售金额</td>
                    <td  class="h nw" style="width:85px;">整套退(套)</td>
                    <td  class="h nw" style="width:85px;">部分退(套)</td>
                    <td  class="h nw" style="width:60px;">退货率</td>
                    <td  class="h nw" style="width:75px;">换货量(套)</td>
                ...
                <asp:Repeater ID="repeater" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="nw" align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("PartRtnQty"), "#,##")%></td>
