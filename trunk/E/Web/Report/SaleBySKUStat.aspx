<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleBySKUStat.aspx.cs" Inherits="Report_SaleBySKUStat" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="销售－按SKU" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td  class="h nw">名称</td>
                    <td  class="h nw" style="width:70px;">颜色</td>
                    <td  class="h nw" style="width:40px;">尺码</td>
