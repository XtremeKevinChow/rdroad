<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleByItemCode.aspx.cs" Inherits="Report_SaleByItemCode" %>
<%@ Register Assembly="Magic.Web.UI" Namespace="Magic.Web.UI" TagPrefix="mwu" %>
<%@ Register Src="../Controls/FunctionTitle.ascx" TagName="FunctionTitle" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>销售情况－按货号统计</title>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="销售情况－按货号统计" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td  class="h nw">名称</td>
                    <td  class="h nw" style="width:80px;">销售数量</td>
                    <td  class="h nw" style="width:80px;">销售金额</td>
                    <td  class="h nw" style="width:80px;">退回数量</td>
                    <td  class="h nw" style="width:80px;">退回金额</td>
                </tr>
                <asp:Repeater ID="repeater" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="nw" align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("RtnAmt"), "#,#0.#0")%></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
        </table>
