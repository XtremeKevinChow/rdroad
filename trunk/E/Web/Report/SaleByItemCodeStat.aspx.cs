...
public partial class Report_SaleByItemCodeStat : System.Web.UI.Page
{
    ...
    private void QueryAndBindData(ISession session, int pageIndex, int pageSize, bool fetchRecordCount)
    {
        ...
        int count = 0;
        this.repeater.DataSource = Report.SaleByItemCodeStat(session, startDate, endDate, this.txtItemCode.Text, Cast.Enum<Report_SaleByCode_OrderBy>(this.drpSort.SelectedValue), this.chkIncludeNoSale.Checked, pageIndex, pageSize, fetchRecordCount, ref count);
    ...
    protected void MagicItemCommand(object sender, MagicItemEventArgs e)
    {
        ...
        using (ISession session = new Session())
        {
            ...
            int count = 0;
            DataSet ds = Report.SaleByItemCodeStat(session, startDate, endDate, this.txtItemCode.Text, Cast.Enum<Report_SaleByCode_OrderBy>(this.drpSort.SelectedValue), this.chkIncludeNoSale.Checked, -1, 0, false, ref count);
