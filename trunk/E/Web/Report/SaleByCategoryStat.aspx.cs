...
public partial class Report_SaleByCategoryStat : System.Web.UI.Page
{
    ...
    private void QueryAndBindData(ISession session, int pageIndex, int pageSize, bool fetchRecordCount)
    {
        ...
        int count = 0;
        this.repeater.DataSource = Report.SaleByCategoryStat(session, startDate, endDate, pageIndex, pageSize, fetchRecordCount, ref count);
