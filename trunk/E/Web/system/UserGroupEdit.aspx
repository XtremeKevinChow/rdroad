<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserGroupEdit.aspx.cs" Inherits="UserGroupEditPage" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="编辑用户组" />
       <!--store the primary keys in the hidden control--> 
        ...
        <table id="editTable" width="100%" border="0" cellspacing="1" cellpadding="0" class="margin_top12px">			
			...
			<tr>
                ...
                <td><asp:TextBox runat="server" ID="txtDescription" MaxLength="250"  ></asp:TextBox></td>
			</tr>
			<tr>
			...
			<tr style="display:none;">
                ...
                <td><asp:TextBox runat="server" ID="txtGroupLevel"  ></asp:TextBox></td>
			</tr>
			 <tr>
				<td></td>
				<td></td>
