<%@ Page Language="C#" AutoEventWireup="true" CodeFile="POReturnManage.aspx.cs" Inherits="Purchase_POReturnManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
      ...
      function viewDetail(ordNumber){
          var url = "POReturnLine.aspx?ordNum=" + ordNumber + "&return=" + escape($("#hidReturnUrl").val());
          window.location.href=url;
      }
	  function ondelete(){
...
<body>
    ...
    <div>
        ...
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="采购退货" />
