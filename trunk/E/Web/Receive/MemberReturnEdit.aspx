<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberReturnEdit.aspx.cs" Inherits="Receive_MemberReturnEdit" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="编辑退货单" />
