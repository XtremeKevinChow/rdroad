<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberReturnLine.aspx.cs" Inherits="Receive_MemberReturnLine" %>
    ...
    <div>
            ...
            <tr>
                <td>
                    <mwu:MagicToolBar CssClass="toolbar" runat="server"
                        Layout="Div" ID="cmdScan1" ToolbarStyle="" OnItemCommand="MagicItemCommand">
                        <Items>
                            <mwu:MagicItem CommandName="New" ItemCssClass="toolbutton" ItemType="Navigate"
                                ImageUrl="../images/b_addL.gif" OnlyClient="true" Text="明细录入">
                            </mwu:MagicItem>
                        </Items>
                    </mwu:MagicToolBar>
                    <mwu:MagicToolBar CssClass="toolbar" runat="server"
                    ...
                    <span runat="server" id="spanMessage" style="color:red;">　　</span>
                </td>
                <td align="right">
                </td>
            </tr>
        ...
        <table class="gridbar" border="0" cellpadding="1" cellspacing="1">
            <tr>
                <td>
                    <mwu:MagicToolBar CssClass="toolbar" runat="server"
                        Layout="Div" ID="cmdScan2" ToolbarStyle="" OnItemCommand="MagicItemCommand">
                        <Items>
                            <mwu:MagicItem CommandName="New" ItemCssClass="toolbutton" ItemType="Navigate"
                                ImageUrl="../images/b_addL.gif" OnlyClient="true" Text="明细录入">
                            </mwu:MagicItem>
