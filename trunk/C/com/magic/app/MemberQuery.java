...
public class MemberQuery extends BaseServlet 
{
    ...
    private String getSubject()
  {
    ...
    s=s+"<tr>\n";
    s=s+"<td> <span class=\"OraHeader\">查询会员数据</span>\n";
  ...
  public String addQueryView(SessionInfo si)
  {
        ...
        s=s+"<input type=\"hidden\" name=\"doc_type\" value=\"1000\" >\n";
        s=s+"<input type=\"hidden\" name=\"act\" value=\"DEFAULT\"> \n"; 
        DocType doc=new DocType(1000);
        ...
        s=s+"</td>\n";
        s=s+"</tr>\n";
        DocType doc_2=new DocType(1010);
        fds=doc_2.getFields();
        ...
        s=s+"<tr><td colspan=2>\n";
     	s=s+"<table width=\"750\" border=0 cellspacing=0 cellpadding=0 background=\"/images/headerlinepixel_onwhite.gif\" HEIGHT=1 WIDTH=1>\n";
        s=s+"<tr background=\"../crmjsp/images/headerlinepixel_onwhite.gif\" HEIGHT=1 WIDTH=1>\n";
        s=s+"<td  height=1 width=\"100%\" background=\"../crmjsp/images/headerlinepixel_onwhite.gif\" HEIGHT=1 WIDTH=1><img src=\"../crmjsp/images/headerlinepixel_onwhite.gif\" HEIGHT=1 WIDTH=1></td>\n";
        s=s+"</tr></table></td></tr>\n";
        s=s+"<tr>\n";
