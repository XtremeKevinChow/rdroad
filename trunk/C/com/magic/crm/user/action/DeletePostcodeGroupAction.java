...
public class DeletePostcodeGroupAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			PostCodeSetDAO.deleteSetByFK(conn, groupForm);
			PostCodeSetDAO.deleteGroupByPK(conn, groupForm);
			conn.commit();
		} catch(Exception e) {
			conn.rollback();
			throw new ServletException("[**an error occured when you delete postcode group**]");
		} finally {
