...
public class ConsoleRMembersAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			String cardId = MemberDAO.getCard_ID(conn, Integer
					.parseInt(member_id));
			request.setAttribute("cardId", cardId);
			Collection memberGetMemberCol = memberDAO.MBR_GET_MBR_info(conn,
					member_id);
