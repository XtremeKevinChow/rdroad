...
<html:form action="/nsInbound?type=add" method="post">
...
<table width="750.0" border=0 cellspacing=1 cellpadding=5 >
	...
	<td> 
		<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">库存管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">三无单新增</font><font color="838383">
...
<table id="detailTable" style="display:block" width="95%" border=0 cellspacing=1 cellpadding=5 >
	...
	<tr>
		...
		<html:text property="itemCode" size="8" /><input name="query" type="button" value="查询" onclick="openWin('../product/productQuery.do?actn=selectProduct', 'PopWin', 700, 450);document.forms[0].whichLine.value=this.parentElement.parentElement.rowIndex;">
		</td>
		<td class=OraTableCellText noWrap align=left ></td>
		<td class=OraTableCellText noWrap align=middle ><html:text property="goodQty" size="8"/></td>
		<td class=OraTableCellText noWrap align=middle ><html:text  property="badQty" size="8"/></td>
