...
function save_activity() {
	...
	frm.action = "expExchangeActivity.do?type=addActivity";
	frm.submit();
}
...
<table id="dataTable" align="center" width="500" border="1" cellSpacing=0 bordercolorlight="#183648" bordercolordark="#ffffff">
    <tr>
		<td class="dataInput">请定义活动类型：</td>
		<td>
		积分兑换
		<input type=hidden name="activityType" value="1">
		<!--
		<html:radio name="activityForm" property="activityType" value="1"/>&nbsp;&nbsp;
		介绍人兑换<html:radio name="activityForm" property="activityType" value="2"/>
		-->
		</td>
	</tr>
    <tr>
		<td class="dataInput">请定义活动号：</td>
		<td><html:text name="activityForm" property="activityNo"/></td>
	</tr>
	<tr>
		<td class="dataInput">请定义活动名称：</td>
	...
	<tr>
		...
		<a href="javascript:show_calendar(document.forms[0].giftLastDate)"><img src="../crmjsp/images/icon_date.gif" border=0 align="top"><a>
