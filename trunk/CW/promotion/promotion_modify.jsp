    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">促销管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">修改促销</font><font color="838383">&nbsp; 
      	</font></td>
   </tr>
</table>
...
<html:form action="promotionOperation.do?type=modify" method="post" onsubmit="return f_checkData();">  
 ...
 <tr> 
	...
	<html:select property="flag">
        ...
        <html:option value="4">xx元任选几件</html:option>
    </html:select>
    </td>
 </tr>
 <tr> 
    ...
    <html:select property="putbasket">
        <html:option value="0">全部可用</html:option>
        <html:option value="1">仅网上使用</html:option>
        <html:option value="2">仅网下使用</html:option>
    </html:select>       
    </td>
 </tr>
