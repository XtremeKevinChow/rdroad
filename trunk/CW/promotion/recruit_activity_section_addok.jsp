...
try{
		 ...
		 if(Recruit_Activity_SectionDAO.checkName(conn,info)>0){
%>
<table width="95%" align="center" border=0 cellspacing=1  class="OraTableRowHeader" noWrap >
	<tr>
		<td bgcolor="#FFFFFF" ><font color="red">操作失败！名称已存在。<a href="javascript:history.back(-1);">请重新设置</a></font></td>
...
<%		 
		...
		Recruit_Activity_SectionDAO.insert(conn,info);
%>
<table width="95%" align="center" border=0 cellspacing=1  class="OraTableRowHeader" noWrap >
	<tr>
