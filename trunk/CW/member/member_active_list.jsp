...
<br>
<html:form  action="/queryActiveList.do" method="post" onsubmit="return querySubmit();">
<input type="hidden" name="tag" value="crmuse">
<table width="95%" align="center" border=0 cellspacing=1 cellpadding=5 >
	<tr>
		<td>MSC号码：<html:text property="MSC"/>&nbsp;&nbsp;MSC名称：<html:text property="name"/>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit" name="queryBtn" value="查询"></td>
