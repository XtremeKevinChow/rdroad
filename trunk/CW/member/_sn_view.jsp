...
<table width="98%" cellspacing="0" cellpadding="4"  border="1" bordercolor="#FFFFFF" bordercolorlight="#cccccc" align="center">
	<tr>
		...
		<td width="30%" class=OraTableCellText noWrap align=left><a href=javascript:ajaxpage("../order/orderView.do?orderId=<bean:write name="order" property="orderId" format="#"/>","ajaxcontentarea","obj")><bean:write name="order" property="orderNumber"/></a>&nbsp;</td>
	</tr>
	<tr>
...
<table cellspacing=2 cellpadding=5 width="98%"  border=0 align="center">
		<tbody>
			...
			<tr>
      		...
      		<tr>
				<td class=OraTableCellText  noWrap colspan="4" align=left>礼券抵用<a href="javascript:viewGifts2('<bean:write name="snMst" property="sn_id" format="#"/>');">[查看]</a></td>
      		...
      		<tr>
				...
				<td class=OraTableCellText noWrap colspan="1"  align=right><bean:write name="snMst" property="discount_fee" format="#0.00"/>
				</td>
				<td colspan=2>&nbsp;</td>
      		</tr>
      		<tr>
  ...
  <table width="98%" border="0" cellpadding="2" cellspacing="0" align="center">
		...
		<tr> 
			<td align="center">
				...
				<input type="button" name="Submit243" value="删除" onClick="javascript:if (confirm('确实要删除吗?')) {ajaxpage('../member/consoleDeleteSn.do?sn_id=<bean:write name="snMst" property="sn_id"/>','ajaxcontentarea','obj'); }">
				</logic:equal>
				<!-- <input type="button" name="Submit243" class="button1" value="打印" onClick="javascript:f_print();">       &nbsp; -->
				<input type="button" name="Submit243"  value=" 返回 " onclick=queryFahuo('../member/consoleSnQuery.do','<bean:write name="order" property="orderNumber"/>')>
      </td>
    </tr>
  </table>
  <br>
