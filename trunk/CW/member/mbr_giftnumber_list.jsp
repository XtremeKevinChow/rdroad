...
function exchange_f(obj) {
	...
	if (flag == true)
	{
		if (confirm("确实要取消礼券吗?"))
		{
			document.forms[0].action = "/member/mbrGetAward.do?type=cancelGiftNumber";
			obj.disabled;
    ...
    <tr>
      	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">帐户管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">礼券查询</font><font color="838383"> 
      	</td>
   </tr>
</table>
<html:form action="/mbrGetAward.do?type=queryGiftNumber">
...
<table  align="center" width="98%" border=0 cellspacing=1 cellpadding=1 >
	<tr>
		...
		礼券号:	<html:text property="gift_number" size="8"/>&nbsp;&nbsp;
		类型：
...
<table width="98%" align="center" border=0  id="DataTable">
	<tr>
		...
		<th width="20%"  class="OraTableRowHeader" noWrap align=middle  >礼券号</th>
		...
		<th width="10%"  class="OraTableRowHeader" noWrap align=middle  >可用次数</th>
		<th width="10%"  class="OraTableRowHeader" noWrap align=middle  >已用次数</th>
	...
	&nbsp;<bean:write name="giftList" property="gift_number"/>
	</td>
    ...
    <logic:equal name="giftList" property="type" value="17">入会礼券</logic:equal>
	</td>
	...
	<td  noWrap align="left" >
	<bean:write name="giftList" property="total_num"/>
	</td>
	<td  noWrap align="left" >
	<bean:write name="giftList" property="num"/>
	</td>
	<td noWrap align="left" >
	<logic:equal name="giftList" property="status" value="0">可使用</logic:equal>
	...
	<logic:equal name="giftList" property="status" value="1">已使用</logic:equal>
	<logic:equal name="giftList" property="status" value="10">已使用</logic:equal>
	</td>
	<td  noWrap align="left" >
...
<table width="95%" align="center" border=0 cellspacing=1 cellpadding=5 >
	<tr>
		<td align="center">
		<input type="button" name="addBtn2" value=" 新增礼券 " onclick="add_f2(this)">
		<input type="button" name="addBtn3" value="礼券取消" onclick="exchange_f(this)">&nbsp;&nbsp;
