    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">帐户管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">手工录入</font><font color="838383"> 
      	</td>
   </tr>
</table>
<html:form action="memberaddMoneyManage.do?type=add" >
<table width="95%" border=0 cellspacing=1 cellpadding=5 align=center>
    ...
    <tr>
      <td width="20%" align="right" class="OraTableRowHeader" noWrap >&nbsp;单据日期</td>
      <td align="left" width="70%" nowarp >
    ...
    <tr>
      <td align="center" colspan=2>
	    <input type="button" name="addBtn" value=" 保存 "  onclick="f_checkForm()">&nbsp;
	  </td>
    </tr>
  </table>
