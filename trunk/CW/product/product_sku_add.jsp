    ...
    <tr>
    	...
    	<td valign="bottom">
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">产品管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">新增产品sku</font><font color="838383">&nbsp; 
      	</font></td>
   </tr>
</table>
<html:form action="/productSKU.do?type=add" method="post" onsubmit="return checkInput();">
...
<table width="750.0" border=0 cellspacing=1 cellpadding=1  align="center" >
 <tr> 
    ...
    <td width="196" align="left" >&nbsp; <html:text property="item_code" maxlength="10" onblur="item_code_change();"/>
