...
<form action="productBase.do?type=addColor" method="post" onsubmit="return checkInput();">
<table width="100%" border="0" cellspacing=1 cellpadding=5 >
  <tr>
    <td><span class="OraHeader">增加颜色</span>
...
<table width="100%" border=0 cellspacing=1 cellpadding=5>
<tr>
<th width="30%" class=OraTableRowHeader noWrap align=middle>编号<font color=red>*</font></th><td width="30%"><input type="text" name="color_code" size=30></td><td>&nbsp;</td>
</tr>
<tr>
<th width="30%" class=OraTableRowHeader noWrap align=middle>名称<font color=red>*</font></th><td width="30%"><input type="text" name="color_name" size=30></td><td>&nbsp;</td>
</tr>
</table>
