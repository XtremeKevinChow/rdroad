    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">产品管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">目录促销产品加印分析</font><font color="838383"> 
      	</td>
   </tr>
</table>
...
<table width="1200 align="center" border=0 cellspacing=1 cellpadding=2 class="OraTableRowHeader" noWrap >
	<tr>
      ...
      <th width="60"  bgcolor="#FFFFFF" noWrap align=middle  rowspan="2">供应商代码</th>
      <th width="140"  bgcolor="#FFFFFF" noWrap align=middle  rowspan="2">供应商名称</th>
...
%>
	<tr align=center>
		...
		<td bgcolor="#FFFFFF" noWrap colspan="22"><a href="product_sell_analyze_promotion_net_execl.jsp?release_date=<%=release_date%>&pro_code=<%=pro_code%>&pro_name=<%=pro_name%>">生成execl文件</a></td>
