...
<table width="90%" border=0  align="center" cellpadding=3 cellspacing=1 bgcolor="#99CCFF" >
  ...
  <tr> 
    ...
    <td align="left"  bgcolor="#ffffff" >
    	<logic:match name="<%=Constants.PRODUCT_FORM%>" property="ifPresell" value="0">否</logic:match>
    	<logic:match name="<%=Constants.PRODUCT_FORM%>" property="ifPresell" value="1">是</logic:match>    
    </td>
	<td align="right"  class="OraTableRowHeader" noWrap  >所属俱乐部</td>
	<td align="left"  bgcolor="#ffffff" >
		<logic:equal name="<%=Constants.PRODUCT_FORM%>" property="clubID" value="1">99</logic:equal> 
		<logic:equal name="<%=Constants.PRODUCT_FORM%>" property="clubID" value="2">99妈咪宝贝</logic:equal> 
	</td>	    
  </tr> 

  <tr> 
    <td align="right"  class="OraTableRowHeader" noWrap  >&nbsp;适合年龄段</td>
    <td align="left" colspan="3"  bgcolor="#ffffff" > <bean:write name="<%=Constants.PRODUCT_FORM%>" property="ageSegment"/>
    </td>
