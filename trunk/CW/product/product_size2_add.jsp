...
<form action="productBase.do?type=addSize2" method="post" onsubmit="return checkInput();">
<table width="100%" border="0" cellspacing=1 cellpadding=5 >
  <tr>
    <td><span class="OraHeader">增加副尺码</span>
...
<table width="100%" border=0 cellspacing=1 cellpadding=5>
<tr>
<th width="30%" class=OraTableColumnHeader noWrap align=middle>编号<font color=red>*</font></th><td width="30%"><input type="text" name="size_code" size=30></td><td>&nbsp;</td>
</tr>
<tr>
<th width="30%" class=OraTableColumnHeader noWrap align=middle>大类<font color=red>*</font></th><td width="30%">
<select name="type_id">
<%
