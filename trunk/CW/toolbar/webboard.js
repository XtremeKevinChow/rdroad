...
var replysStartTag=" <span style='color: blue'>(";var replysEndTag=")</span>";
var expandedTree=false;var showNumberOfReplys=true;
...
var fromWord="From";
var subjectWord="Subject";var sentWord="Sent";
...
function initNewEditorPrime()
{
	fixEditorSize();
	loadCookies();
	document.all.group.value=opener.parent.treeframe.document.body.group;updateToField();
}
function initEditEditor()
{
	document.all.pwd.value=opener.parent.treeframe.document.body.password;
	initEditor();window.onload=initEditEditorPrime;
}
