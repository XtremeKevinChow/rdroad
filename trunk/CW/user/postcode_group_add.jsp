...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" onload="document.forms[0].groupName.focus()">
<br>
    ...
    <tr>
        ...
        <td>
            <font color="838383"><b>当前位置</b></font><font color="838383"> : </font><font color="838383">用户管理</font><font color="838383">
              -&gt; </font><font color="838383">增加邮编组</font>
          </td>
   </tr>
</table>
<br>
<html:form method="post" action="/createPostcodeGroup.do">
         ...
         <table width="100%" cellspacing="0" cellspacing="0" border="1" bordercolordark="#ffffff"  class="en">
               <tr>
                ...
                <tr  align="center">
										...
										<td colspan="2">
												<input type="button" value="提交"  onclick="add_f()">
