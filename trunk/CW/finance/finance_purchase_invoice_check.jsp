...
function check_f() {
	...
	if (flag == true)//有记录打上钩
	{
		if (confirm("确定审核这(些)记录吗?"))
		{
			...
			document.forms[0].action = "finPurchaseInvoiceCheck.do?type=check";
...
<html:form action="finPurchaseInvoiceCheck.do?type=queryUncheckedList" method="POST">
    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">财务管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">采购发票审核</font><font color="838383"> 
      	</td>
   </tr>
</table>
...
<table width="95%" border="0"  cellpadding="0" cellspacing="0" align="center">
  ...
  <tr>
		<td>
			发票号：
			<html:text property="factAPCode" size="25"/>&nbsp;&nbsp;&nbsp;
		</td>
		<td>
