//*******************************************
// ** Description:  Data Access Object for StockBalanceSum
...
namespace Magic.ERP.Report
{
	...
	/// <summary>
	/// Data Access Object for StockBalanceSum
	/// </summary>
	[Table("INV_STOCK_BALANCE_SUM")]
	public partial class  StockBalanceSum : IEntity
	{
		...
		[Column(Name = "CATALOG_ID", DbType = StdDbType.Int32, IsPrimary = true)]
		...
		public static StockBalanceSum Retrieve(ISession session, int periodID, int categoryID)
		{
			return EntityManager.Retrieve<StockBalanceSum>(session, new string[]{ "PeriodID", "CategoryID" },  new object[]{ periodID, categoryID });
		}
		public static bool Delete(ISession session, int periodID, int categoryID)
		{
			return EntityManager.Delete<StockBalanceSum>(session, new string[]{ "PeriodID", "CategoryID" },  new object[]{ periodID, categoryID })>0;
		}
		#endregion
	}
}
