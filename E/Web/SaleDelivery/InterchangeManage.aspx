<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InterchangeManage.aspx.cs" Inherits="SaleDelivery_InterchangeManage" %>
...
<body>
    ...
    <div>
        ...
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="交接单管理" />
        <table class="queryArea" cellpadding="0" cellspacing="0" style="background-color: #aaa;">
            <tr>
                ...
                <td style="width:110px;">
                    <asp:TextBox ID="txtOrderNumber" runat="server" MaxLength="13" CssClass="input" Width="100px"></asp:TextBox>
                </td>
                <td class="label" style="width:50px;">
                    配送商&nbsp;
                </td>
                <td style="width:105px;">
                    <asp:DropDownList ID="drpLogistic" runat="server" Width="100px" CssClass="select">
                    </asp:DropDownList>
                </td>
        ...
        <table class="datalist" id="data_list_table" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:100px;">交接单号</th>
                    <th style="width:50px;">状态</th>
                    <th style="width:80px;">签核结果</th>
                    <th style="width:70px;">交接人</th>
                    <th style="width:110px;">交接时间</th>
                    <th>备注</th>
                </tr>
            </thead>
            <tbody>
                <asp:Repeater ID="repeatControl" runat="server" onitemdatabound="repeatControl_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width:70px;">
                                <%# RenderUtil.FormatString(Eval("CompanyUser"))%>
                            </td>
                            <td style="width:110px;"><%# RenderUtil.FormatDatetime(Eval("InterchangeTime"))%></td>
