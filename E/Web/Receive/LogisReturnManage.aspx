<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogisReturnManage.aspx.cs" Inherits="Receive_LogisReturnManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
      ...
      function viewDetail(ordNumber){
          var url = "LogisReturnLine.aspx?ordNum=" + ordNumber + "&return=" + escape($("#hidReturnUrl").val());
          window.location.href=url;
      }
	  function ondelete(){
...
<body>
    ...
    <div>
        ...
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="物流公司退货" ExtInfo="系统只支持物流公司全退的情况" />
                ...
                <asp:Repeater ID="repeatControl" runat="server" onitemdatabound="repeatControl_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# RenderUtil.FormatString(Eval("LogisName"))%>
                            </td>
                            <td style="width:100px;">
