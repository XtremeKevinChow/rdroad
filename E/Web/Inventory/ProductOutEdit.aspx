<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductOutEdit.aspx.cs" Inherits="Inventory_ProductOutEdit" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="修改产品领用单" />
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
                <td class="label" style="width:30%;">领用单号码：</td>
                <td>
            ...
            <tr>
                <td class="label" style="width:30%;">领用人：</td>
                <td>
                    <asp:TextBox runat="server" ID="txtResponsible" Width="120px" CssClass="input" MaxLength="20"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="label">
