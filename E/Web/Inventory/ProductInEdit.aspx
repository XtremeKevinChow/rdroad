<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductInEdit.aspx.cs" Inherits="Inventory_ProductInEdit" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="修改产品入库单" />
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
                <td class="label" style="width:20%;">入库单号码：</td>
                <td>
            ...
            <tr>
                <td class="label">领用单号码：</td>
                <td>
                    <asp:TextBox runat="server" ID="txtRefOrdNum" Width="120px" CssClass="input" MaxLength="18"></asp:TextBox>
                    <span>&nbsp;&nbsp;&nbsp;如果是产品领用归还/退回，输入原来的领用单号码，系统会自动将领用的明细添加到这张入库单中</span>
                </td>
            </tr>
            <tr>
                <td class="label">
