<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductOutManage.aspx.cs" Inherits="Inventory_ProductOutManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
      ...
      function viewDetail(ordNumber){
          var url = "ProductOutLine.aspx?ordNum=" + ordNumber + "&return=" + escape($("#hidReturnUrl").val());
          window.location.href=url;
      }
	  function ondelete(){
...
<body>
    ...
    <div>
        ...
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="产品领用" />
        ...
        <table class="datalist" id="data_list_table" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width:100px;">领用单号</th>
                    <th style="width:50px;">状态</th>
                    <th style="width:80px;">签核结果</th>
                    <th style="width:70px;">领用人</th>
                ...
                <asp:Repeater ID="repeatControl" runat="server" onitemdatabound="repeatControl_ItemDataBound">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width:70px;">
                                <%# RenderUtil.FormatString(Eval("Responsible"))%>
                            </td>
                            <td style="width:70px;">
