<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferEdit.aspx.cs" Inherits="Inventory_TransferEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function saveCheck() {
            if ($.trim($("#drpFromLocation").val()).length <= 0 || $.trim($("#drpToLocation").val()).length <= 0) {
                alert("必须来源仓库和目标仓库");
                return false;
            }
            return true;
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="移库单编辑" />
        <table width="100%" border="0" cellspacing="1" cellpadding="0">
            <tr>
                <td class="label" style="width:30%;">移库单号码：</td>
                <td>
                    <asp:TextBox runat="server" ID="txtOrderNumber" Width="120px" CssClass="input readonly" ReadOnly="true" MaxLength="18"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="label">来源仓库：</td>
                <td>
                    <asp:DropDownList ID="drpFromLocation" runat="server" CssClass="select" Width="150px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="label">目标仓库：</td>
                <td>
                    <asp:DropDownList ID="drpToLocation" runat="server" CssClass="select" Width="150px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
