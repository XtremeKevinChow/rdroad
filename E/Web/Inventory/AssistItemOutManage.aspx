<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssistItemOutManage.aspx.cs" Inherits="Inventory_AssistItemOutManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
      ...
      function Edit(ordNumber){
          var url = "AssistItemOutEdit.aspx";
      ...
      function viewDetail(ordNumber){
          var url = "AssistItemOutLine.aspx?ordNum="+ordNumber+"&return="+escape($("#hidReturnUrl").val());
          window.location.href=url;
      }
	  function ondelete(){
...
<body>
    ...
    <div>
        ...
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="辅料领用" />
