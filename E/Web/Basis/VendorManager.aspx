<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VendorManager.aspx.cs" Inherits="system_Vendor" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">  
	  ...
	  function Edit(id)
	  {
	        var url = "VendorEdit.aspx?mode=edit&id=" + id ;
	  ...
	  function AddNew()
	  {
	     var url = "VendorEdit.aspx?mode=new";
        var returnUrl = $("#hidReturnUrl").val();
        window.location.href = url + "&return="+escape(returnUrl);
	  }
...
<body>
    ...
    <div>
        <input type="hidden" id="hidReturnUrl" runat="server" value="VendorManager.aspx" />
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="供应商管理" />
            ...
            <tbody>
                <asp:Repeater ID="rptVendor" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td>
                                <input id="checkbox" value='<%# Eval("VendorID") %>' type="checkbox" runat="server" />
                            </td>
                            <td>
                                <a href='javascript:Edit(<%# Eval("VendorID") %>)'>编辑</a>
                            </td>
                            <td>
                            <%# Eval("ShortName")%>
                             </td>
                            ...
                            <td>
                               <%# Magic.Basis.Vendor.VendorStatusText(Magic.Framework.Utils.Cast.Enum<Magic.Basis.VendorStatus>(Eval("Status")))%>
                            </td>
                            <td>
                               <%# Eval("Contact")%>
                            </td>
