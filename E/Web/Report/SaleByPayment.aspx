<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleByPayment.aspx.cs" Inherits="Report_SaleByPayment" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="订单－按付款方式统计" />
