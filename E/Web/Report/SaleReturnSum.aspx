<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleReturnSum.aspx.cs" Inherits="Report_SaleReturnSum" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="退货统计" ExtInfo="每一个物流公司可以点击，查看详细的退货清单" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td  class="h nw">退回礼金</td>
                    <td  class="h nw">退回帐户</td>
