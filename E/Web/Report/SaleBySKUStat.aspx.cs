...
public partial class Report_SaleBySKUStat : System.Web.UI.Page
{
    ...
    private void QueryAndBindData(ISession session, int pageIndex, int pageSize, bool fetchRecordCount)
    {
        ...
        int count = 0;
        this.repeater.DataSource = Report.SaleBySKUStat(session, startDate, endDate, this.txtItemCode.Text, pageIndex, pageSize, fetchRecordCount, ref count);
    ...
    protected void MagicItemCommand(object sender, MagicItemEventArgs e)
    {
        ...
        using (ISession session = new Session())
        {
            ...
            int count = 0;
            DataSet ds = Report.SaleBySKUStat(session, startDate, endDate, this.txtItemCode.Text, -1, 0, false, ref count);
