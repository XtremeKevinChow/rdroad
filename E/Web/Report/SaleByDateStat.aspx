<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaleByDateStat.aspx.cs" Inherits="Report_SaleByDateStat" %>
...
<body>
    ...
    <div>
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="每日销售" />
        ...
        <table class="datalist2" id="data_list_table" cellpadding="0" cellspacing="0" style="width:380px;">
                <tr>
                    <td  class="h nw">日期</td>
                    <td  class="h nw">订单数</td>
                    <td  class="h nw">金额(元)</td>
                    <td  class="h nw">销售件数合计</td>
                </tr>
                <asp:Repeater ID="repeater" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td class="nw"><%# Eval("OrdDate")%></td>
                            <td class="nw" align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("OrdCount"), "#,##")%></td>
                            <td class="nw" align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("OrdAmt"), "#0.#0")%></td>
                            <td class="nw" align="right" style="padding-right:4px;"><%# RenderUtil.FormatNumber(Eval("LineCount"), "#,##")%></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
        </table>
