...
public partial class Report_SaleBySetCodeStat : System.Web.UI.Page
{
    ...
    private void QueryAndBindData(ISession session, int pageIndex, int pageSize, bool fetchRecordCount)
    {
        ...
        int count = 0;
        this.repeater.DataSource = Report.SaleBySetCodeStat(session, startDate, endDate, "%" + this.txtItemCode.Text + "%", pageIndex, pageSize, fetchRecordCount, ref count);
