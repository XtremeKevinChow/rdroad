<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashletManage.aspx.cs" Inherits="DashletManagePage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">  
	  ...
	  //Nav to Edit Page
	  function Edit(dashletId)
	  {
	         var url = "DashletEdit.aspx?";
	        if(dashletId)
	        {
	            url +="mode=edit";
	            url += "&dashletId="+ dashletId;
	        }
	        else
	        {
	            url +="mode=new" ;
...
<body>
    ...
    <div class="queryPage">
        <input type="hidden" id="hidReturnUrl" runat="server" value="DashletManage.aspx" /> 
        <uc1:FunctionTitle ID="functionTitle" runat="server" PageTitle="Dashlet管理" />
...
<td></td>
        ...
        <div class="gridArea">
            ...
            <table class="datalist" id="data_list_table" border="0" cellpadding="0" cellspacing="1"
                ...
                <asp:Repeater ID="rptDashlet" runat="server">
                <ItemTemplate>
                     <tr>
                            <td>
                                <input id="checkbox"   dashletId='<%# Eval("DashletId") %>'   type="checkbox" runat="server" />
                            </td>
                            <td>
                                <a href="javascript:Edit('<%# Eval("DashletId")%>')" >编辑</a>
                            </td>                            
							<td>	<%#WebUtil.FindTextByValue(this.ddlCategory, Eval("Category"),true) %></td>
							<td>	<%# Eval("Title") %></td>
							<td>	<%# Eval("Description") %></td>
							<td>	<%# Eval("InstanceMethod") %></td>
                        </tr>
                </ItemTemplate>
                </asp:Repeater>         
            </table>
