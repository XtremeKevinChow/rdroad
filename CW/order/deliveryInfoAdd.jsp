...
<html:form action="/deliveryInfoAdd.do" onsubmit="return validate(this)"> 
...
<table width="600" cellspacing="0" border="0" align="center">
  ...
  <tr> 
    ...
    <td colspan="3"> 
      <html:text name="deliveryInfoForm" property="postCode" maxlength="6" />
      <font color="#FF0000">*</font> </td>
  </tr>
  <tr> 
