    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">帐户管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">礼金手工充值</font><font color="838383"> 
      	</td>
   </tr>
</table>
<html:form action="orderPay.do?type=submitPayEmoney" onsubmit="return f_checkForm();">
<table width="750.0" border=0 cellspacing=1 cellpadding=5>
	...
	<tr>
      <td width="30%" align="right" ><font color=red>*</font>&nbsp;会员号</td>
		...
		<tr>
      <td width="30%" align="right" ><font color=red>*</font>&nbsp;礼金金额</td>
      <td align="left" width="40%" nowarp>
   ...
   <tr>
      ...
      <td align="left" width="40%" nowarp>
   	...
   	<input type="hidden" name="auto_Level" value="0">
<tr>
