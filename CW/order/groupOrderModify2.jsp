...
function priorStep() {
	...
	document.forms[0].action = "groupOrderUpdate.do?type=refreshFirst";
...
function changeAddress(newValue) {
	...
	if(newValue != null && trim(newValue) != "") {
		document.forms[0].action = "groupOrderUpdate.do?type=changeAddress";
...
function changeDelivery(newValue) {
	if(newValue != null && trim(newValue) != "" && document.forms[0].deliveryTypeId.value != newValue) {
		document.forms[0].action = "groupOrderUpdate.do?type=changeDelivery";
...
function changePayment(newValue) {
	if(newValue != null && trim(newValue) != "" && document.forms[0].paymentTypeId.value != newValue) {
		document.forms[0].action = "groupOrderUpdate.do?type=changePayment";
...
<html:form action="/groupOrderUpdate.do?type=updateSubmit"> 
<!-- 折扣 -->
...
<table width="95%" align="center" cellspacing="0" border="0">
  <tr> 
	...
	<input type="hidden" name="orderId" value="<bean:write name="orgOrder" property="orderId" format="#0"/>">
...
<table width="95%" align="center" cellspacing="0" border="1" bordercolordark="#ffffff" bordercolorlight="#183648" >
  ...
  <tr > 
    ...
    (<bean:write name="item" property="set_code"/>)
		...
		<td align="center">&nbsp;<bean:write name="item" property="color_code"/></td>
...
<table width="95%" border="0"  cellpadding="1" cellspacing="1" align="center">
  ...
  <tr> 
    ...
    <td>
      <input name="chgpay" type="button" value="修改送货方式" onclick="openWin('deliveryType.do?mbId=<bean:write name="orderForm" property="mbId" format="#"/>', '', 650, 500);">
  ...
  <tr> 
    <td colspan="2">
      <!--
      <input name="chgaddress" type="button" value="修改送货地址" onclick="openWin('deliveryInfoList.do?mbId=<bean:write name="orderForm" property="mbId" format="#"/>', '', 650, 500)"> 
      -->
