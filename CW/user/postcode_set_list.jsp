...
<table width="95%" cellspacing="0" cellspacing="0" border="1" bordercolordark="#ffffff"  align="center" class="en">
   <tr>
        <td width="20%"  class="OraTableRowHeader" noWrap >组名称</td>
        <td>
		   <bean:write name="groupData" property="groupName" />
		</td>
   <tr>
         <td width="20%"  class="OraTableRowHeader" noWrap >组描述</td>
         <td>
...
<table width="95%" align="center" cellspacing="0" cellspacing="0" border="1" bordercolordark="#ffffff"  class="en">
  ...
  <tr height="24" valign="middle">
	<th width="" class="OraTableRowHeader" noWrap  class="TableHeader" align="center" >&nbsp;邮编</th>
    	<th width="" class="OraTableRowHeader" noWrap  class="TableHeader" align="center" >&nbsp;邮费</th>
  ...
  <tr align="center">
    ...
    <td align="center" width="100">&nbsp;
      ...
      <input type="button"  value="编辑" onclick="javasript:show_update_f(<bean:write name="postcodeSet" property="id" format="#0"/>)">
      <input type="button"  value="删除" onclick="javasript:delete_f(<bean:write name="postcodeSet" property="id" format="#0"/>)">
    </td>
  </tr>
