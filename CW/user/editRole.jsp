    ...
    <tr>
        ...
        <td>
            <font color="838383"><b>当前位置</b></font><font color="838383"> : </font><font color="838383">用户管理</font><font color="838383">
              -&gt; </font><font color="838383">编辑角色</font>
          </td>
   </tr>
</table>
<html:form method="post" action="/editRole.do">
                          ...
                          <tr class="OraTableRowHeader" noWrap >
                             ...
                             <%
                                ...
                                %>  
                     			...
                     			%>                                                    	 
                      		<td><input type="checkbox" value="<%=rightid1%>" <%if(RoleRightDAO.getRightID(conn,rightid1,roleid)>0){%>checked="checked"<%}%> name="rights" rtname="<%=rightname%>"><%=rightname1%></td>
