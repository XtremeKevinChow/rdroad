    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:clearToPlaceValue()'><IMG SRC='"+imgDir+"clear.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='"+clearToPlaceValueMessage+"'></a><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='"+closeWindowMessage+"'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>");
	...
	function init()	{
		if (!ns4)
		{
			...
			if (showToday==1)
			{
				if(showCharCh==0)
				{
					document.getElementById("lblToday").innerHTML =	todayString + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();'>"+" "+monthName[monthNow].substring(0,3)+" "+dateNow +", "+yearNow+ ", " +dayName[(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+ "</a>";
				}else
				{
					document.getElementById("lblToday").innerHTML =	todayString + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();'>"+yearNow	+unescape("%u5E74")+monthName[monthNow].substring(0,3)	+dateNow +unescape("%u65E5")+ ", " +unescape("%u661F%u671F")+dayName[(today.getDay()-startAt==-1)?6:(today.getDay()-startAt)]+ "</a>";
				}
			}
	...
	*can use:yyyy-m-d,d-m-yyyy,dd-mm-yyyy,mm-dd-yyyy,m-d-yyy...
	*		:yyyy.mm.dd...
	*		:yyyy/mm/dd...
	*		:yyyy mm dd...
	*		:custom
	*@ctl2:ToPlaceValue control
	*@ct1:the calendar appear below control
	*/
	function show_calendar(ctl2,ctl,format) {
		var	leftpos=0
		var	toppos=0
		...
		if (bPageLoaded)
		{
			...
			{
				hideCalendar()
				if (ctlNow!=ctl) {show_calendar(ctl2,ctl,format)}
			}
			ctlNow = ctl
		}
	}
	
	//hidden the select window by "ESC"
	...
	//hidden the select window by click out this
