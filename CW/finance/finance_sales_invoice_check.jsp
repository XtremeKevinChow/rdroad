...
function check_f() {
	...
	if (flag == true)//有记录打上钩
	{
		if (confirm("确定审核这(些)记录吗?"))
		{
			...
			document.forms[0].action = "finSalesInvoiceCheck.do?type=check";
...
<html:form action="finSalesInvoiceCheck.do?type=queryUncheckedList" method="POST">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      	<td width="21">&nbsp;</td>
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">财务管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">销售发票审核</font><font color="838383"> 
      	</td>
   </tr>
</table>
