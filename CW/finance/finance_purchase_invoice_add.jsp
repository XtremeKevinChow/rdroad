...
function init_f() {
	...
	if (frm.qty != null)
	{
		...
		if (typeof(frm.qty.length) == "undefined") {//不是数组
			...
			frm.amt.value = round( to_number(frm.qty.value) * to_number(frm.purPrice.value), 2 );
			frm.apPrice.value = frm.purPrice.value;
			
			
		} else {
			for (var i = 0; i < frm.qty.length ; i ++ )
			{
				frm.amt[i].value = round( to_number(frm.qty[i].value) * to_number(frm.purPrice[i].value), 2 );
				frm.apPrice[i].value = frm.purPrice[i].value;
			}
...
<body bgcolor="#FFFFFF" text="#000000" onload="init2(DataTable);loadSort2(DataTable, DataTable.rows.length-1);init_f();">
<html:form action="/finPurchaseInvoiceManage.do?type=add" method="POST">
    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">财务管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">新增采购发票</font><font color="838383"> 
      	</td>
   </tr>
</table>
...
<TR>
	<TD>
		...
		1.先填数量，然后填开票金额，价格会随金额的变化而变动；<br>
		2.填上表头税率，明细行税率自动填上，税额，含税金额已经各种合计都会自动计算</font>
	</TD>
</TR>
...
<table id="main" width="95%" align="center" cellspacing="1" cellspacing="1" border="0"  class="OraTableRowHeader" noWrap >  
  <tr height="26"> 
	...
	<td>开票金额：</td>
	<td bgcolor="#FFFFFF">
		<input type="text" name="amt0" size="8" readonly>&nbsp;
    </td>
  </tr>
  <tr height="26"> 
	<td width="12%">发票日期：</td><td width="15%" bgcolor="#FFFFFF">
	<html:text property="invoiceDate" size="10" readonly="false"/><a href="javascript:calendar(document.forms[0].invoiceDate)"><img src="../crmjsp/images/icon_date.gif" border=0 align="top"></a>
...
<table width="95%" align="center" border=0 cellspacing=1 cellpadding=5 id="DataTable">
	<tr>
		...
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>产品代码</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>产品名称</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>预算单价</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>可开票数量</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>本次数量</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>开票单价</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>开票金额</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>税率</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>税额</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle><B>含税金额</B></td>
		<td width=""  class="OraTableRowHeader" noWrap  noWrap align=middle sort=false></td>
	</tr>
	...
	<tr>
		...
		<td class=OraTableCellText noWrap align=left width="200">
		<bean:write name="list" property="itemName"/>
		</td>

		<td class=OraTableCellText noWrap align=right width="50">
		<input type="hidden" name="purPrice" value="<bean:write name="list" property="purPrice" format="#0.00"/>">
		<bean:write name="list" property="purPrice" format="#0.00"/>
		</td>

		<td class=OraTableCellText noWrap align=right width="50">
		<input type="hidden" name="useQty" value="<bean:write name="list" property="useQty" format="#0"/>">
		<bean:write name="list" property="useQty" format="#0"/>
		</td>

		<td class=OraTableCellText noWrap align=right width="50">
			<input name="qty" size="6" value="<bean:write name="list" property="useQty" format="#0"/>" onchange="check_qty(this.parentElement.parentElement.rowIndex);">
		</td>

		<td class=OraTableCellText noWrap align=right width="50">
		<input type="text" name="apPrice" size="6" onchange="check_apprice(this.parentElement.parentElement.rowIndex);">
		</td>

		<td class=OraTableCellText noWrap align=right width="">
			<input name="amt" size="6" onchange="check_amt(this.parentElement.parentElement.rowIndex);">
		</td>

		<td class=OraTableCellText noWrap align=right width="50">
			<input name="itemTax" size="6" onchange="check_itemTax(this.parentElement.parentElement.rowIndex)">
		</td>

		<td class=OraTableCellText noWrap align=right width="">
			<input name="taxAmt" size="6" onchange="check_taxAmt(this.parentElement.parentElement.rowIndex)">
		</td>

		<td class=OraTableCellText noWrap align=right width="">
			<input type="text" readonly name="totalAmt" size="6">
		<td class="OraTableCellText" noWrap align=middle width="30">
			<!-- 雪藏了采购到货单明细PK -->
			<input type="hidden" name="psDtlID" value="<bean:write name="list" property="psDtlID"/>">
			<!-- 雪藏了采购到货单主表PK -->
			<input type="hidden" name="psID" value="<bean:write name="list" property="psID"/>">
	...
	<tr>
		...
		<td class=OraTableCellText colspan="1" align=right id="total0"></td>
		<td class=OraTableCellText colspan="1" align=right></td>
		<td class=OraTableCellText colspan="1" align=right id="total1"></td>
		<td class=OraTableCellText colspan="1" align=right ></td>
		<td class=OraTableCellText colspan="1" align=right id="total2"></td>
		<td class=OraTableCellText colspan="1" align=right id="total3">
		<td class=OraTableCellText colspan="1" align=right>
		</td>
	</tr>
</table>
...
<TR>
	<TD>
		<input type="button" value=" 新增 " onclick="new_f();">&nbsp;&nbsp;
