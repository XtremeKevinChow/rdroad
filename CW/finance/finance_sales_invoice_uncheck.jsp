...
function uncheck_f() {
	...
	if (flag == true)//有记录打上钩
	{
		if (confirm("确定弃审这(些)记录吗?"))
		{
			...
			document.forms[0].action = "finSalesInvoiceUncheck.do?type=uncheck";
...
<html:form action="finSalesInvoiceUncheck.do?type=queryCheckedList" method="POST">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      	<td width="21">&nbsp;</td>
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">财务管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">销售发票弃审</font><font color="838383"> 
      	</td>
   </tr>
</table>
