...
function balance_f() {
	...
	if (flag == true)//有记录打上钩
	{
		if (confirm("确定记帐这(些)记录吗?"))
		{
			...
			document.forms[0].action = "finPurchaseInvoiceBalance.do?type=balance";
...
<html:form action="finPurchaseInvoiceBalance.do?type=queryCheckedList" method="POST">
    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">财务管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">采购发票记帐</font><font color="838383"> 
      	</td>
   </tr>
</table>
