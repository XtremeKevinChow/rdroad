...
<table width="95%" border="0"  cellpadding="0" cellspacing="0" align="center">
	...
	<tr>
		...
		<td>
			采购到货单号：
			<html:text property="psCode" size="25"/>	
		</td>
			<td>
			状态：
			<html:select property="status">		
			<html:option value="">--所有--</html:option>
			<html:option value="1">新建</html:option>
			<html:option value="2">审核</html:option>
			<html:option value="3">部分结算</html:option>
			<html:option value="4">完全结算</html:option>
			</html:select>			
		</td>
		</tr>
		<tr>
		<td>
		供应商代码：
			<html:text property="proNO" size="25"/>	
		</td>		
		<td>
