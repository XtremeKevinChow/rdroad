...
function submitForm(para){
	...
	switch(para){
		case "1":
			...
			url = "productModifyItem.do?actn=add";
			break;
		case "2":
			if(! checkInput("submit")) return false;
			url = "productModifyItem.do?actn=submit";
			break;
...
function delproduct(para){
	var form = document.forms[0];
	url = "productModifyItem.do?actn=del&index="+para;
	form.action = url;
	form.submit();
}
    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">产品管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">修改套装品信息</font><font color="838383">&nbsp; 
      	</font></td>
   </tr>
</table>
<html:form action="/productModifyItem.do" method="post">

	  			<logic:iterate id="product" name="item" >
  			<input type="hidden" name="item_id"  value='<bean:write name="product" property="itemID"/>'>
...
<table width="90%" border="0" cellspacing="1" cellpadding="2" align="center">
	 ...
	 <tr>
		...
		<td align="left" width="80%" nowarp><input type="text" name="name" value='<bean:write name="product" property="name" />'></td>
	...
	<tr>
		...
		<td align="left" >
			<input name="categoryID" value='<bean:write name="product" property="categoryID" />'>
			<a href="javascript:getCategory();"> <img src="../images/icon_lookup.gif" border=0 align="top"></a>
		</td>
		
	</tr>
	 <tr>
		<td width="20%" align="right"  class="OraTableRowHeader" noWrap ><font color=red>*</font>&nbsp;是否售完即止</td>
		<td align="left" width="80%" nowarp><html:radio property="isLastSel" value="1"/>是
  ...
  <tr>
	  ...
	  <textarea cols=30 rows=2 name="comments"><bean:write name="product" property="comments" /></textarea></td>
  ...
  <tbody> 
        ...
        <bean:define id="psf" name="product2Form" property="item" type="java.util.Collection"/> 
  		...
  		<tr>
  			...
  			<td align="right"><bean:write name="product2Form" property="standardPrice" format="#.00"/>
  				<input type="hidden" name="unpurchasingCost"  value="<bean:write name='product2Form' property='unpurchasingCost' format='#.00'/>">
  				
  			</td>
  			<td align="right"><bean:write name="product2Form" property="silverPrice" format="#.00"/></td>
  			<td>
  						<input type="text" name="arraySilverPrice" size="8" value=<bean:write name="product2Form" property="height"  format="#.00"/>>  			
  			</td>
  			<td align="right"><bean:write name="product2Form" property="godenPrice"  format="#.00"/></td>
  			<td>
  						<input type="text" name="arrayGodenPrice" size="8" value=<bean:write name="product2Form" property="weight"  format="#.00"/>>
  			</td>
  			<td align="right"><bean:write name="product2Form" property="platina_Price"  format="#.00"/></td>
  			<td>
  			<input type="text" name="arrayPlatina_Price" size="8" value=<bean:write name="product2Form" property="length"  format="#.00"/>>
  			</td>  			
  			<td align="right"><bean:write name="product2Form" property="webPrice"  format="#.00"/></td>
  			<td>
  						<input type="text" name="arrayWebPrice" size="8" value=<bean:write name="product2Form" property="width"  format="#.00"/>>
  			</td>
...
<table width="90%" border="0" cellspacing="1" cellpadding="5" >
	<tr>
	 <td nowrap align="center">
		<input type="button" class=button2 value=" 修改 "  onclick="javascript:submitForm('2')">
