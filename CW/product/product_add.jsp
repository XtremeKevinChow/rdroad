    ...
    <tr>
    	...
    	<td valign="bottom">
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">产品管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">新增货号</font><font color="838383">&nbsp; 
      	</font></td>
      	<td><font color="red">
...
<table width="80%" border=0 cellspacing=1 cellpadding=1  align="center" >
 <tr> 
  ...
  <tr> 
    ...
    <td align="left" >&nbsp; <html:text property="item_origin" /></td>
...
<table width="80%" border=0 cellspacing=1 cellpadding=1  align="center" >
  ...
  <tr>
    ...
    <td align="left" >&nbsp; <html:text property="max_count"  value="10"/> 
    </td>
  ...
  <tr>
  <td align="right" class="inputLabel" noWrap  >&nbsp;颜色(颜色代码，以逗号分割)</td>
  <td colspan=3>&nbsp; <input type=text name="selcolors" size="80">
  </tr>
  <tr>
  <td align="right" class="inputLabel" noWrap  >&nbsp;尺寸(尺寸代码，以逗号分割)</td>
  <td colspan=3>&nbsp; <input type=text name="selsizes" size="80">
  </tr>
...
<table width="750.0" border=0 cellspacing=1 cellpadding=1  align="center" >  
  <tr align="center" valign="middle"> 
    <td height="32" colspan=17> 
      <input name = "submitButton" id="submitButton" type="submit" class="button5" value=" 保存&产生sku " >
