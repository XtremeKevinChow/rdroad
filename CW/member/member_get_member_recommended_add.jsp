...
<!-- <table width="750.0" border=0 cellspacing=1 cellpadding=5 >
	<tr>
	<td> <span class="OraHeader"><b>会员管理 -&gt; 新增被推荐信息</b></span>
...
<html:form method="post" action="/memberGetMemberAdd2.do" onsubmit="return check_f();">
<html:hidden property="cardId" /><!-- 推荐人卡号 -->
<html:hidden property="recommendedId" /><!-- 被推荐会员ID -->
