...
<table width="95%" align="center" border=0 cellspacing=1  class="OraTableRowHeader" noWrap >
	<tr>		
		...
		<select name="gift_type">
		  <option value="4">公有电子礼券</option>
		  <option value="5">私有电子礼券</option>
		</select>
		</td>	
	</tr>
	<tr>		
...
<table width="95%" align="center" border=0 cellspacing=1  class="OraTableRowHeader" noWrap >
	...
	<tr>		
		<td bgcolor="#FFFFFF" width="150"><font color="red">*</font>礼券抵用金额</td>
		<td bgcolor="#FFFFFF"><input type="text"  name="gift_money" > </td>
		<td bgcolor="#FFFFFF" width="150"><font color="red">*</font>订单最小金额</td>
	...
	<tr>		
		...
		<input type="submit" name="input" value="新  增  活  动">
