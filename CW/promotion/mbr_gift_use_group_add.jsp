...
<%
      ...
      String gift_type=request.getParameter("gift_type");
             gift_type=(gift_type==null||gift_type.equals(""))?"4":gift_type;
      String group_no=request.getParameter("group_no");
             group_no=(group_no==null||group_no.equals(""))?"":group_no;             
    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">市场促销</font><font color="838383"> 
      		-&gt; </font><font color="838383">会员礼券使用组新增</font><font color="838383">&nbsp; 
      	</font></td>
   </tr>
</table>
<form   action="mbr_gift_use_group_add_ok.jsp" method="post" name="form" onsubmit="return queryInput();">
<table width="75%" align="center" border=0 cellspacing=1  class="OraTableRowHeader" noWrap >
	<tr>		
	...
	<%
		  String sql1="select distinct GROUP_NO from MBR_GIFT_USE_GROUP where status<>-1  ";
	...
	<%
		  sql="select * from MBR_GIFT_CERTIFICATES where start_date<=sysdate and end_date>=sysdate+1 and gift_type="+gift_type+" order by id desc ";
