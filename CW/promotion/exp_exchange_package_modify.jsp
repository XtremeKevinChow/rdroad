...
function delete_f(row) {
	...
	frm.action = "/promotion/expExchangePackage.do?type=deleteDtlLine&forward=modify&rowId="+(row-1);
	frm.submit();
}
function additem_f2() {
	var frm = document.forms[0];
	
	frm.action = "/promotion/expExchangePackage.do?type=addDtlLine&forward=modify";
	frm.submit();
}
function additem_f() {
...
<html:form action="expExchangePackage.do?type=modify"  method="POST">
...
<table align="center" width="400" border="1" cellSpacing=0 bordercolorlight="#183648" bordercolordark="#ffffff">
	<tr>
		...
		<td><html:text name="packageForm" property="packageNo" readonly="true"/></td>
	</tr>
	...
	<tr>
		...
		<td><html:textarea cols="24" rows="3" name="packageForm" property="desc"/></td>
	</tr>
	<tr>
		<td class="dataInput">URL</td>
		<td><html:text name="packageForm" property="url" size="50"/></td>
	</tr>
</table>
...
<TABLE width="600" align="center">
  <tr>
	<td align="center">
		...
		<input type="button" value=" 保存 " onclick="modify_package();">
	</td>
  </tr>
</TABLE>
</html:form>
