...
function save_step_gift() {
	...
	frm.action = "expExchangeActivity.do?type=modifyFinish";
	frm.submit();
}
function prevStep() {
	var frm = document.forms[0];
	frm.action = "expExchangeActivity.do?type=backShowModifyStep";
	frm.submit();
}
function additem_f2(beginExp) {
	var frm = document.forms[0];
	frm.action = "expExchangeActivity.do?type=addStepGift&forward=modify_step_gift&queryExp=" + beginExp;
	frm.submit();
}
function delete_f2(beginExp, rowId) {
	var frm = document.forms[0];
	frm.action = "expExchangeActivity.do?type=deleteStepGift&forward=modify_step_gift&queryExp=" + beginExp+"&rowId=" + (rowId-1);
	frm.submit();
}
</SCRIPT>
</head>
...
<table align="center" width="800" border="1" cellSpacing=0 bordercolorlight="#183648" bordercolordark="#ffffff" cellpadding="3" id="detailTable4">
	...
	<input type="hidden" name="stepDtlId" value="<bean:write name="stepDtl" property="id" format="#0"/>">
		<logic:equal name="stepDtl" property="enabled" value="true">
		<td>
		...
		<logic:equal name="stepDtl" property="enabled" value="false">
		<td>
			<input type="hidden" name="stepType" value="<bean:write name="stepDtl" property="stepType"/>">
		...
		<td>
			<input type="hidden" name="no"value="<bean:write name="stepDtl" property="no"/>">
