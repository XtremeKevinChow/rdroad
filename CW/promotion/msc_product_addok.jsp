    ...
    <tr>
    	...
    	<td>
			<b><font color="838383">当前位置</font></b><font color="838383"> : </font><font color="838383">促销管理</font><font color="838383"> 
      		-&gt; </font><font color="838383">新增招募活动行成功</font><font color="838383">&nbsp; 
      	</font></td>
   </tr>
</table>
...
<table  border=0 cellspacing=1 cellpadding=1  width="700" align="center" class="OraTableRowHeader" noWrap   >
	<tr bgcolor="#FFFFFF">
		<td align="center"  ><font color=red>操作成功&nbsp;<a href="msc_product_list.jsp?pricelist_id=<%=pricelist_id%>">招募活动行列表</a></font></td>		
	</tr>
