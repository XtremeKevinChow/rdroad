...
public class File
{
	private FileUpload m_parent; //实例
	private int m_startData; //数据开始位置
	private int m_endData; //数据结束位置
	private int m_size; //
	private String m_fieldname; //字段名
	private String m_filename; //文件名
	private String m_fileExt; //文件扩展名
	private String m_filePathName; //文件路径
	private String m_contentType; //内容类型
	private String m_contentDisp; //内容位置
	private String m_typeMime;
	private String m_subTypeMime;
	private String m_contentString; //内容
	private boolean m_isMissing;
	public static final int SAVEAS_AUTO = 0;
	public static final int SAVEAS_VIRTUAL = 1; //虚似路径
	public static final int SAVEAS_PHYSICAL = 2; //物理路径
	...
	public void fileToField(ResultSet rs, String columnName) throws SQLException, FileUploadException, IOException, ServletException
	{
		long numBlocks = 0L;
