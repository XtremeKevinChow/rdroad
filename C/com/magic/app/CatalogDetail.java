...
public class CatalogDetail extends BaseServlet 
{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        hv.addContent("<BR>");
				if(status==0) {
          hv.addButton("发布目录","../app/pricelistsubmit?act=release&parent_doc_type=1680&card_id="+doc_id);
          hv.addButton("删除目录","../app/pricelistsubmit?act=delete&parent_doc_type=1680&card_id="+doc_id);
				 }
				 if(status==0 || status==100){
           hv.addButton("中止目录","../app/pricelistsubmit?act=pause&parent_doc_type=1680&card_id="+doc_id);
				 }
        hv.addButton("返回", "history.go(-1)");
				hv.addButton("增加目录行","../app/viewnew?doc_type=1650&parent_doc_id="+doc_id);

          hv.addButton("上载目录","../crmjsp/data_upload.jsp?doc_type=1680&t_code=2430&parent_doc_id="+doc_id);

        hv.addButton("修改", "../app/viewupdate?doc_type="+doc_type + "&doc_id="+doc_id);
        hv.addButton("目录表单详细","#catalog");

        hv.addButtons();

        hv.addSubject("复制其他目录表内容");
        ...
        s=s+"<tr><td width=\"20%\" align=\"right\" ><font color=red>*</font>&nbsp;选择目录表</td>\n";
       ...
       // hv.addNewView(DocType.CATALOG_LINE,doc_id);
        ...
        try{
          ...
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>产品编码</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>产品名称</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>销售方式</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>目录版块</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>是否义务书</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>银卡价</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>金卡价</th>\n");
          ss.append("<th width=\"12%\" class=OraTableColumnHeader noWrap align=middle>页码</th>\n");
          ss.append("</tr>\n");
          while(rs.next()){
            ss.append("<tr>\n");
