...
public class PricelistDetail extends BaseServlet 
{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try{
            ...
            pr_type_id=rs.getInt("price_type_id");
        }catch(Exception e)
        {
            e.printStackTrace();
        ...
        hv.setSubject("促销产品内容");
        hv.addContent("<BR>");

        hv.addDetailViewEx(DocType.PRICELIST,doc_id);

        hv.addContent("<BR>");
				if(status==0) {
          hv.addButton("发布","../app/pricelistsubmit?act=release&parent_doc_type=1660&card_id="+doc_id);
          hv.addButton("删除","../app/pricelistsubmit?act=delete&parent_doc_type=1660&card_id="+doc_id);
				}
				if(status==0 || status==100){
          hv.addButton("中止","../app/pricelistsubmit?act=pause&parent_doc_type=1660&card_id="+doc_id);
				}
				hv.addButton("增加行","../app/viewnew?doc_type=1670&parent_doc_id="+doc_id);

				  hv.addButton("上载数据","../crmjsp/data_upload.jsp?doc_type=1660&t_code=2230&parent_doc_id="+doc_id);
        ...
        s=s+"<td align=\"left\" width=\"40%\" nowarp><input type=\"hidden\" id=\"pricelist_id\" name=\"pricelist_id\" value=\"\"> <input id=\"pricelist_name\" name=\"pricelist_name\" value=\"\" readonly onclick=\" select_item('pricelist_id',fm_copy.pricelist_id,fm_copy.pricelist_name,pricelist_id_display);\"> \n";
        s=s+"<a href=\"javascript:select_item('pricelist_id',fm_copy.pricelist_id,fm_copy.pricelist_name,pricelist_id_display);\"><img src=\"../crmjsp/images/icon_lookup.gif\" border=0 align=\"top\"><a>\n";
       ...
       // hv.addSubject("增加价目表行");
        ...
        try{
          ...
          String fm = "fm_config_"+DocType.PRICELIST_LINE;
          ss.append("<form name=\"").append(fm).append("\" method=\"post\">\n");
          ss.append("<input type=\"hidden\" name=\"doc_type\" value=\"").append(DocType.PRICELIST_LINE).append("\">\n");
          ...
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>产品编码</th>\n");
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>产品名称</th>\n");
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>销售方式</th>\n");
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>是否义务书</th>\n");
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>银卡价</th>\n");
          ss.append("<th width=\"16%\" class=OraTableColumnHeader noWrap align=middle>金卡价</th>\n");
          ss.append("</tr>\n");
          while(rs.next()){
            ss.append("<tr>\n");
        ...
        //hv.addConfigListView(DocType.PRICELIST_LINE,"pricelist_id="+doc_id);
        hv.addContent("<BR>");
        /*
        s="<a name='gift'>\n";
				hv.addContent(s);
