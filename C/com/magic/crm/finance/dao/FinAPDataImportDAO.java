 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class FinAPDataImportDAO implements FinDataImportDAOIF {
    ...
    public void execute(Connection conn, FinDataImportForm param) throws SQLException {
        System.out.println("AP producure-----------");
        CallableStatement cstmt = null;
        try {
            cstmt = conn.prepareCall("{call accounts.P_ImportApDataFormErp(?, ?, ?)}");
